...
function medallion(platform:'Microsoft Fabric'|'Databricks'):Project{
 ...
 node(d,'ingestion',fabric?'Data Factory pipeline':'Lakeflow ingestion','process',{provider:platform,icon:fabric?'fabric-pipeline':'generic',summary:'Land source data with ingestion metadata',childViewId:'ingestion-detail'});
