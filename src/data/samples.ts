...
function medallion(platform:'Microsoft Fabric'|'Databricks'):Project{
 ...
 node(d,'ingestion',fabric?'Data Factory pipeline':'Lakeflow ingestion','process',{provider:platform,icon:'generic',summary:'Land source data with ingestion metadata',childViewId:'ingestion-detail'});
