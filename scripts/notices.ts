...
import {iconNotices} from '../src/core/icons';
/** Preserve notices from installed packages; no network access and no font copying. */
export function generateNotices():void {
 const parts=['DIAGRAMCLOUD - INSTALLED DEPENDENCY NOTICES','Generated from this build. Includes build/test dependencies, not just runtime code.','Original application: MIT. Vendor icons: their owners\' terms, listed below from the icon registry; see also THIRD_PARTY_NOTICES.md.','',iconNotices()];
